                  ...
                  new InputStreamReader(con.getInputStream(), "utf-8"))) {
                    ...
                    System.out.println(response.toString());
                     FileWriter file1 = new FileWriter("E:\\Biometrics\\log_response.txt");
                          ...
                          file1.close();
                          if(response.toString().contains("200")) return 0;
                        else return 1;
...
//		writer.write(POST_PARAMS.getBytes().toString());
//		writer.flush();
//		writer.close();
		// For POST only - END
...
//			System.out.println(response.toString());
//                        if(response.toString().contains("0")) return 0;
//                        else return 1;
//		} else {
...
//             }
             ...
             Statement stmt = null , stmt1 = null , stmt2=null;
              ...
              String sql = "";
             if(passNo == null && theCountry == null) {
             sql = "select * from mi.clients_data where national_id = '"+nationalID+"' order by request_date desc";
             }
             else if(nationalID == null){
              sql = "select * from mi.clients_data where PassportNo = '"+passNo+"' and nationality = '"+theCountry+passNo+"' order by request_date desc";
             }
              ResultSet rs = stmt.executeQuery(sql);
              String nationality = "" , national_id = "" , passport_no = "" , passport_expiryDT = "" , country = "" , client_nameA = "",
              client_nameE = "" , requestID = "" , gender = "" , request_status = "" , request_date = "" , license_type = "" , transaction_id = "" 
                      , eye_request_date = "";
              int request_no = -1;
             ...
             out.println ("</script>");
                 ...
                 if(intNotAcc){
                       ...
                       if(medical_conditions_str != null){
                        ...
                        json = "{\"header\": {\"version\": \"1.0\",\"category\": \"request\",\"service\": \" TIT_Medical_Results \",\"timestamp\": \"03-09-2018 13:19\",\"tid\": \"594f2c57-e0d6-4311-87ffac491c4337dd\"},\"body\": {\"RequestID\": "+requestID+",\"MedicalCheckupID\": \""+transID+"\",\"MedicalCheckupDate\": \""+eye_request_date+"\",\"MedicalCheckupResults\": 2,\"MedicalCheckupPhoto\": \"\",\"BloodGroup\": \"\",\"BioPath\": \"\",\"MedicalConditions\": "+medical_conditions_str+"}}";
                       }
                       else{
                       ...
                       json = "{\"header\": {\"version\": \"1.0\",\"category\": \"request\",\"service\": \" TIT_Medical_Results \",\"timestamp\": \"03-09-2018 13:19\",\"tid\": \"594f2c57-e0d6-4311-87ffac491c4337dd\"},\"body\": {\"RequestID\": "+requestID+",\"MedicalCheckupID\": \""+transID+"\",\"MedicalCheckupDate\": \""+eye_request_date+"\",\"MedicalCheckupResults\": 2,\"MedicalCheckupPhoto\": \"\",\"BloodGroup\": \"\",\"BioPath\": \"\",\"MedicalConditions\": []}}";

                       }

                                int res = sendPOST("http://192.168.235.55/drvintegration_test/API/MedicalCheckup/NotifyResults", json , "1");
...
out.println("location='oculist.jsp';");
            out.println("</script>");
                    ...
                    System.out.println("unknown error");
                     ...
                     stmt.executeUpdate("update `clients_data` set `eyes_inspection_result` = '"+result+"' , `inspection_status` = 'W' , `eyes_exam_date` = '"+eye_request_date+"' , `right_eye_degree` = '"+Reye+"' , `left_eye_degree` = '"+Leye+"' where `requestID` ='"+requestID+"'");
                     }
                     else{
                      if(internInspRes.equals("acc") && result.equals("acc")){
                       stmt.executeUpdate("update `clients_data` set `eyes_inspection_result` = '"+result+"' , `inspection_status` = 'C' , `eyes_exam_date` = '"+eye_request_date+"' , `right_eye_degree` = '"+Reye+"' , `left_eye_degree` = '"+Leye+"' where `requestID` ='"+requestID+"'");
                       String json = "";    
                       if(medical_conditions_str != null){
                           ...
                           json = "{\"header\": {\"version\": \"1.0\",\"category\": \"request\",\"service\": \" TIT_Medical_Results \",\"timestamp\": \"03-09-2018 13:19\",\"tid\": \"594f2c57-e0d6-4311-87ffac491c4337dd\"},\"body\": {\"RequestID\": "+requestID+",\"MedicalCheckupID\": \""+transID+"\",\"MedicalCheckupDate\": \""+eye_request_date+"\",\"MedicalCheckupResults\": 1,\"MedicalCheckupPhoto\": \""+photo64+"\",\"BloodGroup\": \"\",\"BioPath\": \"\",\"MedicalConditions\": "+medical_conditions_str+"}}";
                       }
                       else{
                                                //  json = "{\"header\": {\"version\": \"1.0\",\"category\": \"request\",\"service\": \" TIT_Medical_Results \",\"timestamp\": \"03-09-2018 13:19\",\"tid\": \"594f2c57-e0d6-4311-87ffac491c4337dd\"},\"body\": {\"RequestID\": "+requestID+",\"MedicalCheckupID\": \""+transID+"\",\"MedicalCheckupDate\": \""+eye_request_date+"\",\"MedicalCheckupResults\": 1,\"MedicalCheckupPhoto\": \""+photo64+"\",\"BloodGroup\": \"\",\"BioPath\": \""+bioPath+"\",\"MedicalConditions\": []}}";

                       json = "{\"header\": {\"version\": \"1.0\",\"category\": \"request\",\"service\": \" TIT_Medical_Results \",\"timestamp\": \"03-09-2018 13:19\",\"tid\": \"594f2c57-e0d6-4311-87ffac491c4337dd\"},\"body\": {\"RequestID\": "+requestID+",\"MedicalCheckupID\": \""+transID+"\",\"MedicalCheckupDate\": \""+eye_request_date+"\",\"MedicalCheckupResults\": 1,\"MedicalCheckupPhoto\": \""+photo64+"\",\"BloodGroup\": \"\",\"BioPath\": \"\",\"MedicalConditions\": []}}";
